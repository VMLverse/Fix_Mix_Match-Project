...
_Instructions on installing and setting up our app._

1. To install PyTorch, please refer to the Official Link: https://pytorch.org/
...
3. Download the dataset by 
   ...
   Microsoft Windows 10 Only
     ```sh
    C:\Final_Project> cd data 
    C:\Final_Project\data> get_data.bat 
    C:\Final_Project\data> cd ..
      ```
<p align="right">(<a href="#readme-top">back to top</a>)</p>
